...
export function itemSchemaTypeToItemDocument(item: itemSchemaType, id: number, user_id: string, created_at: Date, updated_at: Date, main_image_url: string | null): itemsDocument {
  return {
    id,
    user_id,
    created_at,
