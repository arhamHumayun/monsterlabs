        ...
        <PaginationContent>
          <PaginationItem>
            <PaginationPrevious href={
              currentPage === 1 ? '' : `/browse/${currentPage - 1}`
            } />
          </PaginationItem>
          <PaginationItem>
          ...
          <PaginationItem>
            <PaginationLink href={`/browse/${maxCreaturePage}`} >{maxCreaturePage}</PaginationLink>
          </PaginationItem>
          <PaginationItem>
            <PaginationNext href={
              currentPage === maxCreaturePage ? '' : `/browse/${currentPage + 1}`
            } />
          </PaginationItem>
        </PaginationContent>
      </Pagination>

      <CreatureList pageNumber={currentPage} monstersPerPage={monstersPerPage} />
    </div>
  );
}
